	  ...
	  "content": [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "在选择上建议选择3-8之间的颜色，中性色不建议做主色。Ant Design Mobile的default版本选用的品牌色为@blue－6，即#2db7f5。"
	        ]
	      ]
	    ],
	    [
	      ...
	      [
	        ...
	        {
	          "title": null,
	          "src": "https://os.alipayobjects.com/rmsportal/lNsYPpUKoOZEwnb.png",
	          "alt": "品牌色"
	        }
	      ]
	    ],
	    ...
	    [
	      ...
	      [
	        ...
	        {
	          "title": null,
	          "src": "https://os.alipayobjects.com/rmsportal/ZhcQaUlPcucnYty.png",
	          "alt": "功能色"
	        }
	      ]
	    ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "当UI元素本身为@blure－5的时候默认@blue-6为active颜色。\n实际应用中，使用者只需要调整色相，输入一个固定的值就可以得到一系列基于主色交互变化的色谱。想要深度了解更多关于Ant Design Mobile交互上的色彩变化的详细内容可以参考 ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        {
	          "title": null,
	          "src": "https://os.alipayobjects.com/rmsportal/RZtVRWecHMipAOU.png",
	          "alt": "色彩和交互"
	        }
	      ]
	    ]
	  ...
	  "description": [
	    ...
	    [
	      ...
	      [
	        ...
	        {
	          "title": null,
	          "src": "https://os.alipayobjects.com/rmsportal/kEcoQTCBsjKdlGZ.png",
	          "alt": "色板"
	        }
	      ]
	    ],
	    ...
	    [
	      ...
	      [
	        ...
	        {
	          "title": null,
	          "src": "https://os.alipayobjects.com/rmsportal/VNdsMvNZYwiHjrq.png",
	          "alt": "中性色"
	        }
	      ]
	    ],
